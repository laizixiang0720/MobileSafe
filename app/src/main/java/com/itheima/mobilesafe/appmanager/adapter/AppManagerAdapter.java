...
public class AppManagerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null & convertView instanceof LinearLayout) {
            ...
            viewHolder.mAppIconImgv = convertView.findViewById(R.id.iv_icon);
            viewHolder.mAppLocationTV = convertView.findViewById(R.id.tv_appisroom);
            viewHolder.mAppSizeTV = convertView.findViewById(R.id.tv_size);
            viewHolder.mAppNameTV = convertView.findViewById(R.id.tv_name);
            viewHolder.mLuanchAppTV = convertView.findViewById(R.id.tv_launch);
            viewHolder.mShareAppTV = convertView.findViewById(R.id.tv_share);
            viewHolder.mUninstallTV = convertView.findViewById(R.id.tv_uninstall);
            viewHolder.mAppOptionLL = convertView.findViewById(R.id.ll_option_app);
