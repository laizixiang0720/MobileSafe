...
public class NetDetectionActivity extends Activity implements View.OnClickListener{
    ...
    private void downloadFile(){
        ...
        final String url = "https://vipspeedtest1.wuhan.net.cn:8080/download?r=0.7785169281463817&size=30000000";
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    String mSDCardPath= Environment.getExternalStorageDirectory().
                            getAbsolutePath();
                    File dest = new File(mSDCardPath,"DownLoadFile");
                    sink = Okio.sink(dest);
