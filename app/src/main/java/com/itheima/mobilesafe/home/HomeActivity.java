...
public class HomeActivity extends Activity implements View.OnClickListener {
    ...
    private LinearLayout ll_clean,ll_interception,ll_security,ll_software_manager,ll_netraffic,ll_app_lock;
    //显示程序锁、网速测试、流量监控信息对应的布局
    private RelativeLayout rl_speed_test,title_bar;
    ...
    private void init(){
        ...
        //设置标题栏背景颜色
        findViewById(R.id.title_bar).setBackgroundResource(R.color.white_color);
        ...
        ll_app_lock= findViewById(R.id.ll_app_lock);     //获取程序锁布局
        ll_netraffic=findViewById(R.id.ll_netraffic);   //获取流量监控布局
       ...
       /* ActivityCompat.requestPermissions(HomeActivity.this,
        ...
        ll_app_lock.setOnClickListener(this);         //设置程序锁布局的点击事件监听器
        rl_speed_test.setOnClickListener(this);      //设置网速测试布局的点击事件监听器
        ll_netraffic.setOnClickListener(this);       //设置流量监控布局的点击事件监听器
    }
    @Override
