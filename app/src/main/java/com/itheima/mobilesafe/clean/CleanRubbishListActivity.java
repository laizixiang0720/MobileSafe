    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_cleanall: //“一键清理”按钮点击事件
                if (rubbishMemory > 0) {
                    //跳转到清理垃圾界面
                    Intent CleanRubbish=new Intent(this, CleanRubbishActivity.class);
                    CleanRubbish.putExtra("rubbishSize",rubbishMemory);
                    CleanRubbish.putExtra("rubbishInfos", (Serializable) rubbishInfos);
                    startActivity(CleanRubbish);
                }
                break;
        }
    }
